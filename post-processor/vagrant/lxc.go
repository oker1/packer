...
func (p *LxcBoxPostProcessor) Configure(rLxc ...interface{}) error {
	md, err := common.DecodeConfig(&p.config, rLxc...)
	if err != nil {
		return err
	}
...
func (p *LxcBoxPostProcessor) PostProcess(ui packer.Ui, artifact packer.Artifact) (packer.Artifact, bool, error) {
	...
	return NewArtifact("lxc", outputPath), true, nil
}
